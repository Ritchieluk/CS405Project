...
VALUES (0, 40, 7.99, 'Big Boi Transformer', 'This big ol boi can transform into the biggest of trucks, the largest of cars, and only the most gargantuan of vehicles. Buyer beware. It may or may not be cursed to also transform your life.');

INSERT INTO INVENTORY (INVENTORY_ID, AMOUNT, PRICE, PRODUCT_NAME, PRODUCT_DESC)
VALUES (1, 20, 12.99, 'Polly Hot Pocket', 'This adorable little doll is also the perfect microwavable treat. Just pop it in the microwave and then stick it in your mouth pocket');

INSERT INTO INVENTORY (INVENTORY_ID, AMOUNT, PRICE, PRODUCT_NAME, PRODUCT_DESC)
VALUES (2, 20, 89.99, 'A Singular Lego Brick', 'Add this extremely brick to your collection. Guaranteed to destroy your feet, your social life, and your pocketbook or your money back.');

INSERT INTO INVENTORY (INVENTORY_ID, AMOUNT, PRICE, PRODUCT_NAME, PRODUCT_DESC)
VALUES (3, 30, 2.99, 'Ben 10 Omnitrix', '100% not FDA approved. But we somehow got it to work, just all the DNA is faulty and WILL cause dogs in a 1 mile radius to become feral');

INSERT INTO INVENTORY (INVENTORY_ID, AMOUNT, PRICE, PRODUCT_NAME, PRODUCT_DESC)
VALUES (4, 23, 37.99, 'Barbies Barbecue Backyard By the Backyardigans', 'BYOB, working grill and raw steak (we promise) included.');

INSERT INTO INVENTORY (INVENTORY_ID, AMOUNT, PRICE, PRODUCT_NAME, PRODUCT_DESC)
VALUES (5, 17, 75.99, 'Difficult-Bake Oven', 'Your parents will end up doing it for you. They will get frustrated. They will get divorced. It will be your fault.');
